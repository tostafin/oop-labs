...
class SimulationEngineTest {
    ...
    void runTest() {
        ...
        SimulationEngine engine2 = new SimulationEngine(map2, positions2);
        engine2.setDirections(directions2);
        engine2.run();
        Vector2d[] expectedResults2 = {new Vector2d(2, 0), new Vector2d(3, 5)};
        Vector2d[] actualResults2 = engine2.animalsPos;
