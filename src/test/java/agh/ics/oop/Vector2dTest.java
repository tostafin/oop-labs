...
public class Vector2dTest {
    ...
    public void testOpposite() {
        // Testy z użyciem ustalonych liczb
        assertEquals(new Vector2d(55, -77).opposite(), new Vector2d(-55, 77));
        assertEquals(new Vector2d(-30, 23).opposite(), new Vector2d(30, -23));
        assertNotEquals(new Vector2d(-20, 13).opposite(), new Vector2d(-20, -13));
        assertNotEquals(new Vector2d(67, 90).opposite(), new Vector2d(34, -90));

        // Testy z użyciem pseudolosowych liczb
        int a = ThreadLocalRandom.current().nextInt(-(1 << 15), 1 << 15 + 1);
        int b = ThreadLocalRandom.current().nextInt(-(1 << 15), 1 << 15 + 1);
        assertEquals(new Vector2d(a, b).opposite(), new Vector2d(-a, -b));
        assertNotEquals(new Vector2d(a, b).opposite(), new Vector2d(-a, b));
        assertNotEquals(new Vector2d(a, b).opposite(), new Vector2d(a, -b));
        assertNotEquals(new Vector2d(a, b).opposite(), new Vector2d(a, b));
    }
}
